...
df1 <- read_excel(here::here("Data", "Data 2018-19", "FY2018TSFundingDetails-MinSecReg.xlsx"))
df2 <- read_excel(here::here("Data", "Data 2018-19", "TS2 2018-19.xlsx"))
df3 <- read_excel(here::here("Data", "Data 2018-19", "TS3 2018-19.xlsx"))
...
tot1819 <- split(totdf1819$total, totdf1819$Sector)
...
colnames(df_1819) <- c("four_year1819", "two_year1819", "other1819")

df_1819 <- df_1819 %>%
    mutate(pct_four_year1819 = four_year1819 / tot1819$four_year) %>%
    mutate(pct_two_year1819 = two_year1819 / tot1819$two_year) %>%
    mutate(pct_other1819 = other1819 / tot1819$other)
