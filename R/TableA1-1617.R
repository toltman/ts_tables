...
df1 <- read_excel(here::here("Data", "Data 2016-17", "FY2016TSFundedDetails-MinSecReg.xlsx"))
df2 <- read_excel(here::here("Data", "Data 2016-17", "tblTS2 2016-17.xlsx"))
df3 <- read_excel(here::here("Data", "Data 2016-17", "tblTS3 2016-17.xlsx"))
...
tot1617 <- split(totdf1617$total, totdf1617$Sector)
...
colnames(df_1617) <- c("four_year1617", "two_year1617", "other1617")

df_1617 <- df_1617 %>%
    mutate(pct_four_year1617 = four_year1617 / tot1617$four_year) %>%
    mutate(pct_two_year1617 = two_year1617 / tot1617$two_year) %>%
    mutate(pct_other1617 = other1617 / tot1617$other)
